...
* {file:features/execution_environment_test.feature Test behaviour} when executing in the 'test' execution environment
...
* {file:features/retrieve_configuration.feature retrieving configuration} from a configuration service using the service identifier and credentials injected
* {file:features/configuration_pluggable.feature Injecting a pluggable} configuration provider
