...
* {file:features/bootstrap_with_auditing.feature bootstrapping with auditing configuration}
...
* {file:features/auditing_levels.feature Support audit buffering} when failing to audit to an auditing provider
...
A reference implementation can be found here: https://github.hetzner.co.za/hetznerZA/soar_sc
