...
module SoarSc
  module Authorization
    class AuthorizationPolicyIsAnyone < ::SoarPl::AuthorizationPolicy
      def initialize
        super('authorization-policy-is-anyone', {})
      end
...
module SoarSc
  module Web
    module Models
      class PolicyIsAnyoneModel < ConfiguredModel
